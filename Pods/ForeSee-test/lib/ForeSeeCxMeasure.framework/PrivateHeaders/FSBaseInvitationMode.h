...
@interface FSBaseInvitationMode : NSObject <FSInvitationMode, FSInviteViewDelegate, FSInviteResultDelegate> {
  TRMeasure *measure_;
  BOOL active_;
}
...
@property (nonatomic, strong) id<FSInviteResultDelegate> inviteDelegate;

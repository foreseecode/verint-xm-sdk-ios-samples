...
/** Sets whether or not to enable masking debug for cxReplay
...
/** Erases all stored counts and state in the SDK; resets the Trigger and
 cxReplay modules to be active and recording. This should only be used for
...
/** Check if SessionReplay is running.
 ...
 @return YES if SessionReplay is running, NO otherwise
 */
+ (BOOL)isRecording;
